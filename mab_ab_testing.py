...
class Agent(object):
    def __init__(self, bandits, train_test_split=0.1, num_trails = 10000, band_type = 'gaussian'):
...
if __name__ =="__main__":
    ...
    eps_values = [0.01, 0.1, 0.2, 0.6]
        
    ads_initialized = Agent(ads, band_type="gaussian")
    
    # rewards, best_ad = ads_initialized.epsilon_greedy(0.01)
    # ads_initialized.plot(rewards, mode = 'single epsilon')
    
    for eps in eps_values:
        rewards, best_ad = ads_initialized.epsilon_greedy(eps)
